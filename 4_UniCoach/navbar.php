    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="../../index.html">INDUSTRIAL TRAINING SYSTEM - UNIVERSITY COACH</a>
            </div>
                ...
                <ul class="list">
                    ...
                    <li>
                        <a href="../view_intern.php">
                            ...
                            <span>View Intern</span>
                        </a>
                    </li>
                    <li>
                        <a href="../view_intern_report.php">
                            <i class="material-icons">content_paste</i>
                            <span>View Intern Report</span>
                        </a>
                    </li>
                    <li>
                        <a href="../view_intern.php">
