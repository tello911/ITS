                                ...
                                <form id="exit_survey" method="POST" action="../intern_assessment_process.php" enctype="multipart/form-data">
                                    ...
                                    <div class="tab">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <h5>CONFIDENCE: </h5><br>
                                            <input type="radio" id="qb91" value="1" name="qb9">
                                            <label for="qb91" class="radio-inline">
                                                1
                                            </label>
                                            <input type="radio" id="qb92" value="2" name="qb9">
                                            <label for="qb92" class="radio-inline">
                                                2
                                            </label>
                                            <input type="radio" id="qb93" value="3" name="qb9">
                                            <label for="qb93" class="radio-inline">
                                                3
                                            </label>
                                            <input type="radio" id="qb94" value="4" name="qb9">
                                            <label for="qb94" class="radio-inline">
                                                4
                                            </label>
                                            <input type="radio" id="qb95" value="5" name="qb9">
